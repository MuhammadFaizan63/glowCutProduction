...
export default {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        warm: '0 4px 16px rgba(var(--color-primary), 0.08)',
        'warm-sm': '0 2px 8px rgba(var(--color-primary), 0.06)',
        'warm-lg': '0 8px 32px rgba(var(--color-primary), 0.12)',
        cream: '0 4px 16px rgba(var(--color-secondary), 0.15)',
        'cream-lg': '0 8px 32px rgba(var(--color-secondary), 0.2)',
