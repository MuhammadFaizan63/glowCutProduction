    ...
    >
      ...
      >
        ...
        <div className="max-w-2xl mx-auto glass-elevated p-xl md:p-2xl rounded-2xl relative overflow-hidden border border-primary/20">
          ...
          <motion.button
            onClick={handleJoin}
            className="w-full bg-primary py-6 rounded-xl font-display-lg text-headline-md text-on-primary shadow-warm hover:brightness-110 active:scale-95 transition-all duration-300 flex items-center justify-center gap-3 mb-8"
