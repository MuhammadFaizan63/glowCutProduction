...
export default function ConfirmBooking() {
  ...
  return (
    ...
    >
      <nav className="fixed top-0 w-full z-50 flex justify-between items-center px-6 md:px-margin-desktop h-20 bg-surface/70 backdrop-blur-2xl border-b border-primary/10">
        <button
          onClick={() => navigate(-1)}
