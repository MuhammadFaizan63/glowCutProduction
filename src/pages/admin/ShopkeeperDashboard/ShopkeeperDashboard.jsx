...
export default function ShopkeeperDashboard() {
  ...
  return (
    <motion.div
      className="px-lg max-w-full space-y-xl text-on-surface font-body-md"
      initial="initial"
      animate="animate"
      variants={{
    ...
    >
      ...
      >
                  ...
                  <div className="flex gap-sm">
                    {apt.status === 'pending' && (
                      <button
                        ...
                        className="bg-primary text-on-primary text-xs px-4 py-2 rounded-lg font-bold disabled:opacity-50 disabled:cursor-not-allowed shadow-warm-sm hover:brightness-110 transition-all active:scale-95"
                      >
                        CONFIRM CHECK-IN
                      </button>
                    )}
        ...
        <aside className="lg:col-span-4">
          <div className="glass-panel border border-white/10 rounded-xl flex flex-col h-[500px] overflow-hidden shadow-2xl">
            ...
            <form onSubmit={handleSendMessage} className="p-md border-t border-white/10 flex gap-sm bg-surface-container-lowest">
              ...
              <button
                type="submit"
                className="bg-primary text-on-primary w-10 h-10 rounded-lg flex items-center justify-center hover:brightness-110 active:scale-95 transition-all shadow-warm-sm"
              >
