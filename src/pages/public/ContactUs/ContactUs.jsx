  ...
  return (
    <main className="pt-24 pb-32 px-margin-mobile md:px-margin-desktop max-w-7xl mx-auto font-body-md text-on-surface">
      <header className="mb-xl text-center max-w-2xl mx-auto">
        <h1 className="font-display-lg text-display-lg text-white mb-4">Contact Us</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-xl">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-on-surface-variant">support@glowcut.com</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-full bg-secondary-container/20 flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  ...
                  <p className="text-on-surface-variant">+92 (300) 123-4567</p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-on-surface-variant">Glow Cut Tower, Main Boulevard<br/>PECHS, Karachi</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="lg:col-span-7">
          <form onSubmit={handleSubmit} className="glass-panel p-lg md:p-xl rounded-2xl space-y-6 border border-white/5">
            <h3 className="font-headline-md text-headline-md text-white mb-2">Send us a Message</h3>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="flex flex-col gap-2">
                <label className="text-caption uppercase tracking-widest text-on-surface-variant">Name *</label>
                <input 
                  type="text" 
                  value={formData.name}
                  onChange={(e) => setFormData({...formData, name: e.target.value})}
                  className="bg-surface-container border border-white/10 rounded-lg p-3 text-white focus:outline-none focus:border-secondary transition-colors"
                  placeholder="John Doe"
                />
              </div>
              <div className="flex flex-col gap-2">
                <label className="text-caption uppercase tracking-widest text-on-surface-variant">Email *</label>
                <input 
                  type="email" 
            ...
            <div className="flex flex-col gap-2">
              <label className="text-caption uppercase tracking-widest text-on-surface-variant">Subject</label>
              <input 
                type="text" 
            ...
            <div className="flex flex-col gap-2">
              <label className="text-caption uppercase tracking-widest text-on-surface-variant">Message *</label>
              <textarea 
                rows="5"
                value={formData.message}
                onChange={(e) => setFormData({...formData, message: e.target.value})}
                className="bg-surface-container border border-white/10 rounded-lg p-3 text-white focus:outline-none focus:border-secondary transition-colors resize-none"
