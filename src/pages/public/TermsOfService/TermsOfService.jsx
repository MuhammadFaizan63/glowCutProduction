  ...
  return (
    <main className="pt-24 pb-32 px-margin-mobile md:px-margin-desktop max-w-4xl mx-auto font-body-md text-on-surface">
      <header className="mb-xl text-center">
        ...
        <h1 className="font-display-lg text-display-lg text-white mb-4">Terms of Service</h1>
        <p className="text-on-surface-variant font-label-md">Effective Date: July 28, 2026</p>
      </header>
      ...
      <article className="glass-panel p-lg md:p-xl rounded-2xl space-y-lg border-t-4 border-primary-container">
        ...
        <section>
          <h2 className="font-headline-lg text-headline-lg text-white mb-4">2. User Accounts</h2>
        ...
        <section>
          <h2 className="font-headline-lg text-headline-lg text-white mb-4">3. Booking & Cancellations</h2>
          <p className="text-on-surface-variant leading-relaxed">
        ...
        <section>
          <h2 className="font-headline-lg text-headline-lg text-white mb-4">4. Payments</h2>
          <p className="text-on-surface-variant leading-relaxed">
        ...
        <section>
          <h2 className="font-headline-lg text-headline-lg text-white mb-4">5. Modifications to Service</h2>
          <p className="text-on-surface-variant leading-relaxed">
