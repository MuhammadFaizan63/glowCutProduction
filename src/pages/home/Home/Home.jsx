...
const SVG_DECORATIVE = () => (
  <svg viewBox="0 0 100 100" className="w-full h-full" xmlns="http://www.w3.org/2000/svg" style={{ background: 'rgba(99,176,50,0.03)' }}>
    {[10, 20, 30, 40, 50, 60, 70, 80, 90].map((v) => (
      <g key={v}>
        <line x1={v} y1="0" x2={v} y2="100" stroke="rgba(99,176,50,0.06)" strokeWidth="0.3" />
        <line x1="0" y1={v} x2="100" y2={v} stroke="rgba(99,176,50,0.06)" strokeWidth="0.3" />
      </g>
    ))}
    {[15, 30, 45, 60, 75].map((x) => [15, 30, 45, 60, 75].map((y) => (
      <circle key={`${x}-${y}`} cx={x} cy={y} r="0.6" fill="rgba(99,176,50,0.15)" />
    )))}
    <circle cx="50" cy="50" r="4" fill="rgba(99,176,50,0.2)" />
    <circle cx="50" cy="50" r="2" fill="#63B032" style={{ filter: 'drop-shadow(0 0 4px #63B032)' }} />
  </svg>
);
          ...
          <motion.div className="lg:col-span-7 space-y-lg" variants={itemVariants}>
            ...
            <div className="flex gap-sm flex-wrap">
              <button
                ...
                className="px-xl py-md bg-primary text-on-primary rounded-xl font-bold text-sm shadow-warm hover:brightness-105 active:scale-95 transition-all"
              >
                Book Appointment
              </button>
              <button
        ...
        <div className="relative rounded-3xl p-4 md:p-xl flex flex-col md:flex-row items-center gap-xl border border-primary/20 bg-gradient-to-br from-surface-container to-surface overflow-hidden">
          ...
          <div className="relative z-10 w-full md:w-1/2 flex justify-center">
            <div className="relative group">
              ...
              <img
                alt="AI Style Scan"
                className="w-48 h-48 md:w-72 md:h-96 object-cover rounded-full border-4 border-primary/30 relative z-10"
              ...
              <motion.div
                ...
                className="absolute top-0 -right-4 md:-right-8 bg-surface-container border border-primary/30 p-2 md:p-md rounded-full shadow-warm"
              >
              ...
              <motion.div
                ...
                className="absolute bottom-4 md:bottom-8 -left-4 md:-left-8 bg-surface-container border border-primary/30 p-2 md:p-md rounded-full shadow-warm"
              >
      ...
      <motion.section variants={itemVariants} className="py-xl section-padding">
        ...
        <div className="flex justify-center mt-xl">
          <button
            ...
            className="px-xl py-md bg-primary text-on-primary rounded-xl font-bold shadow-warm hover:brightness-105 active:scale-95 transition-all flex items-center gap-sm"
          >
